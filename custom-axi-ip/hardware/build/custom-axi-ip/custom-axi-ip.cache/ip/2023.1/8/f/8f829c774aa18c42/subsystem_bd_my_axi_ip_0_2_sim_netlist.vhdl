...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_counter is
  ...
  signal q_next1_carry_i_5_n_0 : STD_LOGIC;
  signal q_next1_carry_i_6_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \counter_reg[1]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \counter_reg[2]_i_1\ : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of \counter_reg[7]_i_1\ : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of \q_reg[0]_i_1\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \q_reg[5]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \q_reg[6]_i_1\ : label is "soft_lutpair5";
...
q_next1_carry_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0100FEFF"
    )
        port map (
...
q_next1_carry_i_5: unisim.vcomponents.LUT6
    generic map(
      INIT => X"2222222122222114"
    )
        port map (
      I0 => q_reg_reg(7),
      I1 => q_reg_reg(8),
      ...
      I4 => sw(0),
      I5 => sw(1),
      O => q_next1_carry_i_5_n_0
    );
q_next1_carry_i_6: unisim.vcomponents.LUT6
    generic map(
      INIT => X"1111111111121141"
    )
        port map (
      I0 => q_reg_reg(4),
      I1 => q_reg_reg(5),
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my_axi_ip_v1_0_S00_AXI is
  ...
  attribute SOFT_HLUTNM of \slv_reg3[7]_i_2\ : label is "soft_lutpair9";
begin
