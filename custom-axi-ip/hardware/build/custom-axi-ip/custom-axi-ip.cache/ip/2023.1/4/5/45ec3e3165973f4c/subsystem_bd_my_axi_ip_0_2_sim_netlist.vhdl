...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_single_pulse_detector is
  port (
    btn_pulse : out STD_LOGIC;
    sig : in STD_LOGIC;
    s00_axi_aclk : in STD_LOGIC
  );
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_single_pulse_detector;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_single_pulse_detector is
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my_axi_ip_v1_0 is
  ...
  signal sig : STD_LOGIC;
begin
db_btn_i: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_debounce
     port map (
      rst_btn => rst_btn,
      s00_axi_aclk => s00_axi_aclk,
      sig => sig
...
sp_btn_i: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_single_pulse_detector
     port map (
      btn_pulse => btn_pulse,
      s00_axi_aclk => s00_axi_aclk,
      sig => sig
