...
#
# Script generated by Vivado on Wed Oct 02 16:54:29 PDT 2024
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : subsystem_bd.sh
...
#
# Usage        : subsystem_bd.sh
#                subsystem_bd.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                subsystem_bd.sh [-reset_run]
#                subsystem_bd.sh [-reset_log]
#                subsystem_bd.sh [-help]
#
...
#                script (type 'subsystem_bd.sh -help' for more information).
#
...
# script info
echo -e "subsystem_bd.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./subsystem_bd.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../custom-axi-ip.gen/sources_1/bd/subsystem_bd/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../custom-axi-ip.gen/sources_1/bd/subsystem_bd/ipshared/aed8/hdl" +incdir+"../../../../custom-axi-ip.gen/sources_1/bd/subsystem_bd/ipshared/ec67/hdl" +incdir+"../../../../custom-axi-ip.gen/sources_1/bd/subsystem_bd/ipshared/aed8/hdl" +incdir+"/home/mg/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.subsystem_bd xil_defaultlib.glbl -o subsystem_bd_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./subsystem_bd_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/mg/Documents/my-projects/Embedded-System-Design-with-Xilinx-Zynq-SoC-and-Vitis-IDE/custom-axi-ip/hardware/build/custom-axi-ip/custom-axi-ip.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key subsystem_bd_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc subsystem_bd_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./subsystem_bd.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: subsystem_bd.sh [-help]\n\
Usage: subsystem_bd.sh [-step]\n\
Usage: subsystem_bd.sh [-lib_map_path]\n\
Usage: subsystem_bd.sh [-reset_run]\n\
Usage: subsystem_bd.sh [-reset_log]\n\
Usage: subsystem_bd.sh [-keep_index]\n\
Usage: subsystem_bd.sh [-noclean_files]\n\n\
